...
android {
  ...
  if (!debugKeystoreFile.exists()) {
    try {
      ...
      // Quietly ignore or log if keytool is not available
    }
  }
  ...
  val keystoreFile = if (keystorePathEnv != null) {
    ...
    if (f.isAbsolute) f else rootProject.file(keystorePathEnv)
  } else {
  ...
  signingConfigs {
    create("release") {
      ...
      storePassword = System.getenv("STORE_PASSWORD") ?: "dummy_store_password"
      keyAlias = System.getenv("KEY_ALIAS") ?: "david"
